...
export 'dados_usuario_model.dart';

/// User Profile Information Display
class DadosUsuarioWidget extends StatefulWidget {
  const DadosUsuarioWidget({super.key});

  static String routeName = 'dados_usuario';
  static String routePath = '/dadosUsuario';
...
class _DadosUsuarioWidgetState extends State<DadosUsuarioWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DadosUsuarioModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().dataRegistro = dateTimeFormat(
        "dd/MM/yyyy",
        ...
        body: SafeArea(
          ...
          child: Padding(
            ...
            child: FutureBuilder<ApiCallResponse>(
              future: ApiBairroForteGroup.meusDadosCall.call(
              ...
              builder: (context, snapshot) {
                ...
                final columnMeusDadosResponse = snapshot.data!;
                  ...
                  children: [
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.nomeTextController ??=
                                  ...
                                  text: getJsonField(
                                    columnMeusDadosResponse.jsonBody,
                                    r'''$.user.name''',
                                  ).toString(),
                                ),
                    ...
                    InkWell(
                      ...
                      onTap: () async {
                        ...
                        FFAppState().dataRegistroApi = _model.datePicked;
                        safeSetState(() {});
                      },
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        ...
                        children: [
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              _model.apiResultwov = await ApiBairroForteGroup
                                  .atualizarUsuarioCall
                                  .call(
                                name: _model.nomeTextController.text,
                                gender: _model.sexoValue,
                              ...
                              if ((_model.apiResultwov?.succeeded ?? true)) {
                                await showDialog(
                                  context: context,
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: Text('Ops...!'),
                                      content: Text(
                                          'Ocorreu algo inesperado ao tentar atualizar seus dados,tente novamente'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
                                              Navigator.pop(alertDialogContext),
