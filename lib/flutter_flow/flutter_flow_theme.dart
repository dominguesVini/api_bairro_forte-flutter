...
abstract class FlutterFlowTheme {
  ...
  late Color corFundoComponentes;
  late Color corFundoTextField;
  late Color sliderRaioEmKM;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color corPrimaria = const Color(0xFF294452);
  late Color corFundoComponentes = const Color(0xFFF1F4F8);
  late Color corFundoTextField = const Color(0xFFD3D3D3);
  late Color sliderRaioEmKM = const Color(0xFFF5CBA2);
}
