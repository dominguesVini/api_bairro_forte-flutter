    ...
    try {
      ...
      if (e.code == 'requires-recent-login') {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(
                  'Muito tempo desde o último acesso. Faça login novamente antes de excluir sua conta.')),
        );
      }
    }
  }
    ...
    try {
      ...
      if (e.code == 'requires-recent-login') {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(
                  'Muito tempo desde o último acesso. Faça login novamente antes de atualizar seu e-mail.')),
        );
      }
    }
  }
  ...
  Future<BaseAuthUser?> _signInOrCreateAccount(
    ...
    try {
      ...
      return userCredential == null
          ? null
          : BairroForteFirebaseUser.fromUserCredential(userCredential);
    } on FirebaseAuthException catch (e) {
