...
import 'create_account06_model.dart';
export 'create_account06_model.dart';

class CreateAccount06Widget extends StatefulWidget {
  const CreateAccount06Widget({super.key});

  static String routeName = 'createAccount_06';
  static String routePath = '/createAccount06';

  @override
  State<CreateAccount06Widget> createState() => _CreateAccount06WidgetState();
}

class _CreateAccount06WidgetState extends State<CreateAccount06Widget> {
  late CreateAccount06Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateAccount06Model());
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                safeSetState(() {});
                                _model.envioCodigo =
                                    await EnviarCodigoVerificacaoCall.call(
                                  to: '+55${_model.phoneNumberTextController.text}',
                                );

                                if ((_model.envioCodigo?.succeeded ?? true)) {
                                  ...
                                  context.pushNamed(
                                    CreateAccount07Widget.routeName,
                                    queryParameters: {
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        title: Text('Ops...'),
                                        content: Text(
                                            'Ocorreu um erro ao tentar enviar o código, tente novamente mais tarde!'),
                                        actions: [
                                          TextButton(
