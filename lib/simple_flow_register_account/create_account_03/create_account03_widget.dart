...
import 'create_account03_model.dart';
export 'create_account03_model.dart';

class CreateAccount03Widget extends StatefulWidget {
  const CreateAccount03Widget({super.key});

  static String routeName = 'createAccount_03';
  static String routePath = '/createAccount03';

  @override
  State<CreateAccount03Widget> createState() => _CreateAccount03WidgetState();
}

class _CreateAccount03WidgetState extends State<CreateAccount03Widget> {
  late CreateAccount03Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateAccount03Model());
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                context.pushNamed(
                                  CreateAccount04Widget.routeName,
                                ...
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      ...
                                      _model.resultadoCriarUsuarioG4 =
                                      ...
                                      if ((_model.resultadoCriarUsuarioG4
                                              ?.succeeded ??
                                          true)) {
