...
import 'card_registro_cameras_model.dart';
export 'card_registro_cameras_model.dart';

class CardRegistroCamerasWidget extends StatefulWidget {
  const CardRegistroCamerasWidget({
    super.key,
  ...
  @override
  State<CardRegistroCamerasWidget> createState() =>
      _CardRegistroCamerasWidgetState();
}

class _CardRegistroCamerasWidgetState extends State<CardRegistroCamerasWidget> {
  late CardRegistroCamerasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CardRegistroCamerasModel());

    _model.descriptionCameraTextController ??= TextEditingController();
    _model.descriptionCameraFocusNode ??= FocusNode();
                            ...
                            children: [
                              Expanded(
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.descriptionCameraTextController,
                                    focusNode:
                                        _model.descriptionCameraFocusNode,
                                    onChanged: (_) => EasyDebounce.debounce(
                                      ...
                                      () async {
                                        FFAppState().updateCameraStruct(
                                          (e) => e
                                            ..description = _model
                                                .descriptionCameraTextController
                                                .text,
                                        );
                                        safeSetState(() {});
                                      },
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              FFButtonWidget(
                                onPressed: () async {
                                  _model.resultadoCadCamera01 =
                                      await ApiBairroForteGroup.newCameraCall
                                          .call(
                                    description: _model
                                        .descriptionCameraTextController.text,
                                    latitude: FFAppState().camera.latitude,
                                    longitude: FFAppState().camera.longitude,
                                    shared: true,
                                    token: currentJwtToken,
                                  );

                                  if ((_model.resultadoCadCamera01?.succeeded ??
                                      true)) {
                                    await showDialog(
                                      context: context,
                                      ...
                                      await showDialog(
                                        ...
                                        builder: (alertDialogContext) {
                                          return AlertDialog(
                                            title: Text('Opss!'),
                                            content: Text(
                                                'Ocorreu um erro ao tentar cadastrar sua câmera, tente novamente!'),
                                            actions: [
                                              TextButton(
                                                onPressed: () => Navigator.pop(
                                                    alertDialogContext),
