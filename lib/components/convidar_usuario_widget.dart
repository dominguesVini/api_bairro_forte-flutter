                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  _model.resultApiIncident =
                                      await ApiBairroForteGroup.newIncidentCall
                                          .call(
                                    latitude: FFAppState().Incident.latitude,
                                    longitude: FFAppState().Incident.longitude,
                                    description:
                                        _model.emailUsuarioTextController.text,
                                  );

                                  if (FFAppConstants.SUCESSO ==
                                      getJsonField(
