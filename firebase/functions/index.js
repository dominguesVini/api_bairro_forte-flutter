...
const kUserKey = "<user_key_onje_signal>";
const kAPIKey = "<one_signal_api>";
...
exports.deleteUser = functions.https.onCall(async (data, context) => {
  ...
  const url = `https://api.onesignal.com/apps/<app_id_one_signal>/users/by/external_id/${data.user_id}`;
